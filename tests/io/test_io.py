...
def test_open_metek_average_dataset(metek_ave_gz_file):
...
def test_open_metek_average_datatree(metek_ave_gz_file):
    ds = open_metek_datatree(metek_ave_gz_file)
...
def test_open_metek_processed_dataset(metek_pro_gz_file):
...
def test_open_metek_processed_datatree(metek_pro_gz_file):
    ds = open_metek_datatree(metek_pro_gz_file)
    assert "corrected_reflectivity" in ds["sweep_0"].variables.keys()
    assert "velocity" in ds["sweep_0"].variables.keys()
...
def test_open_metek_raw_dataset(metek_raw_gz_file):
...
def test_open_metek_raw_datatree(metek_raw_gz_file):
    ds = open_metek_datatree(metek_raw_gz_file)
